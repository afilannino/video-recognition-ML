...
from pytorch_liteflownet.correlation import correlation  # the custom cost volume layer
...
def run(model, first, second, out):
	main(model, first, second, out)
...
def main(model, first, second, out):
	arguments_strModel = model
	arguments_strFirst = first
	arguments_strSecond = second
...
if __name__ == '__main__':
	print('Illegal usage. Please import run() method')
